  ...
  Widget _buildTodoList() {
    return new ListView.builder(
      itemBuilder: (context, index) {
        // itemBuilder will be automatically be called as many times as
        // it takes for the list to fill up its available space, which is most
        // likely more than the number of todo_items we have. So, we need
        // to check the index is OK.
